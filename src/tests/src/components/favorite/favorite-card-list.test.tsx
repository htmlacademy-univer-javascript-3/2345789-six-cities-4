...
import FavoriteCardsList from '../../../../components/favorite/favorite-cards-list';
...
describe('Component: FavoriteCardsList', () => {
    ...
    render(
      <Provider store={ store } >
        <MemoryRouter initialEntries={['/']}>
          <FavoriteCardsList cards={sampleCards} />
        </MemoryRouter>
      </Provider>
    );
  ...
  it('should sort cards by price low to high when sortType is LOW_TO_HIGH', () => {
    render(
      <Provider store={ store } >
        <MemoryRouter initialEntries={['/']}>
          <FavoriteCardsList cards={sampleCards} sortType={filters.LOW_TO_HIGH} />
        </MemoryRouter>
      </Provider>
    );
  ...
  it('should sort cards by price high to low when sortType is HIGH_TO_LOW', () => {
    render(
      <Provider store={ store } >
        <MemoryRouter initialEntries={['/']}>
          <FavoriteCardsList cards={sampleCards} sortType={filters.HIGH_TO_LOW} />
        </MemoryRouter>
      </Provider>
    );
  ...
  it('should sort cards by rating top rated first when sortType is TOP_RATED', () => {
    render(
      <Provider store={ store } >
        <MemoryRouter initialEntries={['/']}>
          <FavoriteCardsList cards={sampleCards} sortType={filters.TOP_RATED} />
        </MemoryRouter>
      </Provider>
    );
